...
def depthFirstSearch(problem):
  ...
  while (not fridge.isEmpty()) and (not problem.isGoalState(agentState)):
    agentState, agentActions = fridge.pop()
    explored.append(agentState)
    successors = problem.getSuccessors(agentState)
